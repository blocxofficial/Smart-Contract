...
// 
    ...
    Telegram : https://t.me/blocxchain
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc92663C239662dF7C1E94d9bAbbE749e9e7fCF93;
...
contract BlocX is Context, IERC20, Ownable { 
    using SafeMath for uint256;
    using Address for address;


    // Function for tracking the status of wallets
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    // Blacklist function: If 'noBlackList' is set to true wallets on this list cannot buy : This is used for bots
    ...
    */
    ...
    address payable private Wallet_Owner = payable(0xc92663C239662dF7C1E94d9bAbbE749e9e7fCF93);
    ...
    */
    ...
    string private _name = "BlocX"; 
    string private _symbol = "BLX";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _tFeeTotal;

    // Counter for the liquify trigger
    uint8 private txCount = 0;
    uint8 private swapTrigger = 3; 

    // This is the max fee that the contract can be set to which is defult at 20, This means that there will be a limit of 20% sell & buy tax, Owner will not be able to increase the fee higher then 20% at anytime it is hard-coded into the smart contract to protect buyers
    ...
    */
    ...
    The constructor functions will only be called one time. This will happen during the deployment of the smart contract.
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[Wallet_Owner] = true;
    ...
    */
    ...
    // Update main wallet
    function Wallet_Update_Owner(address payable wallet) public onlyOwner() {
        Wallet_Owner = wallet;
        _isExcludedFromFee[Wallet_Owner] = true;
    }
    ...
    */
    ...
    The Blacklist feature is used to block a certain wallet from being able to buy. This function will be called for wallet that are using bots to buy or conduct unwanted transactions that can manipulate BlocX.
    ...
    */
    ...
    This function noFeeToTransfer is used to create a 0% fee when sending BlocX tokens to another wallet, when its set on true.
    ...
    */
    ...
    This will create a limit to the wallet in both Transaction ability and Holding ability, creating a safer environment.
    ...
    */
    ...
    This fee's will be added to the smart contract as $BLX tokens and the function will exchange the tokens to BNB and sent to the wallet. 
    One wallet will be used for all the fee's. 
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(Wallet_Owner,contractBNB);
    }
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        (uint256 tTransferAmount, uint256 tOwner) = _getValues(tAmount);
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 tOwner = tAmount*_TotalFee/100;
